  ...
  return (
    <div className='container'>
      ...
      <div className='p-5'>
        ...
        <p>
          Lorem ipsum dolor sit amet consectetur, adipisicing elit. Provident eum ipsum similique, porro sed natus
          delectus. Voluptate asperiores officia ab ullam aliquam saepe accusantium, itaque illo sunt, aut, culpa cum.
          Fugiat nemo laudantium excepturi voluptates. Quos, dolorum architecto tempore exercitationem impedit nesciunt
       
        </p>
        <br />
   <Link to={'/add'}>
        <button style={{borderRadius:"4px",height:"3rem"}} className='bg-success'>Add New Employee</button>
